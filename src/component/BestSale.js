                ...
                <div className='grid md:grid-cols-2 h-full'>
                    <div className='md:ml-80 flex justify-center flex-col text-left font-semibold'>
                        ...
                        <div className='flex justify-start mt-6 items-center'>
                            <button className='hover:transform hover:scale-105 transition-transform duration-300 ease-in-out text-center items-center rounded-3xl bg-orange-500 w-48 h-12 text-white text-2xl font-semibold ' type="text">Liên hệ ngay</button></div>
                    </div>
                    <div className='flex justify-center items-center hover:transform hover:scale-105 transition-transform duration-300 ease-in-out'>
                        <img className='md:w-2/4 md:h-2/4' src={g7} alt=""></img>
                    </div>
                </div>
            </div>
        </div>
